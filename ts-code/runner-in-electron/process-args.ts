...
const platformArgDefs: ArgDef[] = [
	...
	{
		name: 'skip-fs-mounting',
		type: Boolean,
		description: `Skip mounting into file system (with FUSE on Linux, macFUSE on Mac).`
	},
	{
		name: 'platform-cmd',
		type: String,
...
export const SKIP_FS_MOUNTING_FLAG = !!parsedCliArgs['skip-fs-mounting'];
