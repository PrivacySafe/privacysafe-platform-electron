...
import { makeHTTPException, makeConnectionException, HTTPException } from '../../platform/lib-common/exceptions/http';
import { BytesFIFOBuffer } from '../../platform/lib-common/byte-streaming/bytes-fifo-buffer';
...
import { toBuffer, utf8 } from '../../platform/lib-common/buffer-utils';
