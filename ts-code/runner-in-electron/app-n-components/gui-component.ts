...
import { copy as jsonCopy } from '../../platform/lib-common/json-utils';
...
import { conformWinOptsToFormFactor } from '../caps/ui';
import { AppCAPsAndSetup, GUIComponent as GUIComponentType, Service } from '../../platform/inject-defs/apps';
...
async function nativeImageFromFile(
	appRoot: AppFolder, imgPath: string, domain: string
