...
/** Namespace shell_fs_resource. */
export namespace shell_fs_resource {

    /** Properties of a GetFSResourceRequestBody. */
    interface IGetFSResourceRequestBody {

        /** GetFSResourceRequestBody appDomain */
        appDomain?: (common.IStringValue|null);

        /** GetFSResourceRequestBody resourceName */
        resourceName?: (string|null);
    }

    /** Represents a GetFSResourceRequestBody. */
    class GetFSResourceRequestBody implements IGetFSResourceRequestBody {

        /**
         * Constructs a new GetFSResourceRequestBody.
         * @param [properties] Properties to set
         */
        constructor(properties?: shell_fs_resource.IGetFSResourceRequestBody);
        ...
        /**
         * Creates a new GetFSResourceRequestBody instance using the specified properties.
         * @param [properties] Properties to set
         * @returns GetFSResourceRequestBody instance
         */
        public static create(properties?: shell_fs_resource.IGetFSResourceRequestBody): shell_fs_resource.GetFSResourceRequestBody;

        /**
         * Encodes the specified GetFSResourceRequestBody message. Does not implicitly {@link shell_fs_resource.GetFSResourceRequestBody.verify|verify} messages.
         * @param message GetFSResourceRequestBody message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: shell_fs_resource.IGetFSResourceRequestBody, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Encodes the specified GetFSResourceRequestBody message, length delimited. Does not implicitly {@link shell_fs_resource.GetFSResourceRequestBody.verify|verify} messages.
         * @param message GetFSResourceRequestBody message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encodeDelimited(message: shell_fs_resource.IGetFSResourceRequestBody, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Decodes a GetFSResourceRequestBody message from the specified reader or buffer.
         * @param reader Reader or buffer to decode from
         * @param [length] Message length if known beforehand
         * @returns GetFSResourceRequestBody
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): shell_fs_resource.GetFSResourceRequestBody;

        /**
         * Decodes a GetFSResourceRequestBody message from the specified reader or buffer, length delimited.
         * @param reader Reader or buffer to decode from
         * @returns GetFSResourceRequestBody
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): shell_fs_resource.GetFSResourceRequestBody;

        /**
         * Verifies a GetFSResourceRequestBody message.
        ...
        /**
         * Creates a GetFSResourceRequestBody message from a plain object. Also converts values to their respective internal types.
         * @param object Plain object
         * @returns GetFSResourceRequestBody
         */
        public static fromObject(object: { [k: string]: any }): shell_fs_resource.GetFSResourceRequestBody;

        /**
         * Creates a plain object from a GetFSResourceRequestBody message. Also converts values to other types if specified.
         * @param message GetFSResourceRequestBody
         * @param [options] Conversion options
         * @returns Plain object
         */
        public static toObject(message: shell_fs_resource.GetFSResourceRequestBody, options?: $protobuf.IConversionOptions): { [k: string]: any };

        /**
         * Converts this GetFSResourceRequestBody to JSON.
         * @returns JSON object
         */
        public toJSON(): { [k: string]: any };

        /**
         * Gets the default type url for GetFSResourceRequestBody
    ...
    /** Properties of a GetFSResourceReplyBody. */
    interface IGetFSResourceReplyBody {

        /** GetFSResourceReplyBody folder */
        folder?: (fs.IFS|null);

        /** GetFSResourceReplyBody file */
        file?: (file.IFile|null);
    }

    /** Represents a GetFSResourceReplyBody. */
    class GetFSResourceReplyBody implements IGetFSResourceReplyBody {

        /**
         * Constructs a new GetFSResourceReplyBody.
         * @param [properties] Properties to set
         */
        constructor(properties?: shell_fs_resource.IGetFSResourceReplyBody);
        ...
        /**
         * Creates a new GetFSResourceReplyBody instance using the specified properties.
         * @param [properties] Properties to set
         * @returns GetFSResourceReplyBody instance
         */
        public static create(properties?: shell_fs_resource.IGetFSResourceReplyBody): shell_fs_resource.GetFSResourceReplyBody;

        /**
         * Encodes the specified GetFSResourceReplyBody message. Does not implicitly {@link shell_fs_resource.GetFSResourceReplyBody.verify|verify} messages.
         * @param message GetFSResourceReplyBody message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: shell_fs_resource.IGetFSResourceReplyBody, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Encodes the specified GetFSResourceReplyBody message, length delimited. Does not implicitly {@link shell_fs_resource.GetFSResourceReplyBody.verify|verify} messages.
         * @param message GetFSResourceReplyBody message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encodeDelimited(message: shell_fs_resource.IGetFSResourceReplyBody, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Decodes a GetFSResourceReplyBody message from the specified reader or buffer.
         * @param reader Reader or buffer to decode from
         * @param [length] Message length if known beforehand
         * @returns GetFSResourceReplyBody
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): shell_fs_resource.GetFSResourceReplyBody;

        /**
         * Decodes a GetFSResourceReplyBody message from the specified reader or buffer, length delimited.
         * @param reader Reader or buffer to decode from
         * @returns GetFSResourceReplyBody
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): shell_fs_resource.GetFSResourceReplyBody;

        /**
         * Verifies a GetFSResourceReplyBody message.
         * @param message Plain object to verify
         * @returns `null` if valid, otherwise the reason why it is not
         */
        public static verify(message: { [k: string]: any }): (string|null);
        ...
        /**
         * Creates a GetFSResourceReplyBody message from a plain object. Also converts values to their respective internal types.
         * @param object Plain object
         * @returns GetFSResourceReplyBody
         */
        public static fromObject(object: { [k: string]: any }): shell_fs_resource.GetFSResourceReplyBody;

        /**
         * Creates a plain object from a GetFSResourceReplyBody message. Also converts values to other types if specified.
         * @param message GetFSResourceReplyBody
         * @param [options] Conversion options
         * @returns Plain object
         */
        public static toObject(message: shell_fs_resource.GetFSResourceReplyBody, options?: $protobuf.IConversionOptions): { [k: string]: any };

        /**
         * Converts this GetFSResourceReplyBody to JSON.
         * @returns JSON object
         */
        public toJSON(): { [k: string]: any };

        /**
         * Gets the default type url for GetFSResourceReplyBody
         * @param [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns The default type url
         */
        public static getTypeUrl(typeUrlPrefix?: string): string;
