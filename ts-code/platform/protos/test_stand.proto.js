...
$root.test_stand = (function() {
    ...
    test_stand.SendMsgToOtherLocalTestProcessRequestBody = (function() {
         ...
         */
        SendMsgToOtherLocalTestProcessRequestBody.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.userNum != null && Object.hasOwnProperty.call(message, "userNum"))
                $root.common.UInt32Value.encode(message.userNum, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            if (message.appDomain != null && Object.hasOwnProperty.call(message, "appDomain"))
                $root.common.StringValue.encode(message.appDomain, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            if (message.appComponent != null && Object.hasOwnProperty.call(message, "appComponent"))
                $root.common.StringValue.encode(message.appComponent, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
         ...
         */
        SendMsgToOtherLocalTestProcessRequestBody.decode = function decode(reader, length, error) {
            ...
            while (reader.pos < end) {
                ...
                switch (tag >>> 3) {
                case 1: {
                        message.userNum = $root.common.UInt32Value.decode(reader, reader.uint32());
                        break;
                    }
                case 2: {
                        message.appDomain = $root.common.StringValue.decode(reader, reader.uint32());
                        break;
                    }
                case 3: {
                        message.appComponent = $root.common.StringValue.decode(reader, reader.uint32());
                        break;
                    }
                case 4: {
         ...
         */
        SendMsgToOtherLocalTestProcessRequestBody.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.userNum != null && message.hasOwnProperty("userNum")) {
                var error = $root.common.UInt32Value.verify(message.userNum);
                if (error)
                    return "userNum." + error;
            }
            if (message.appDomain != null && message.hasOwnProperty("appDomain")) {
                var error = $root.common.StringValue.verify(message.appDomain);
                if (error)
                    return "appDomain." + error;
            }
            if (message.appComponent != null && message.hasOwnProperty("appComponent")) {
                var error = $root.common.StringValue.verify(message.appComponent);
                if (error)
                    return "appComponent." + error;
            }
            if (message.msgJson != null && message.hasOwnProperty("msgJson"))
         ...
         * @returns {test_stand.SendMsgToOtherLocalTestProcessRequestBody} SendMsgToOtherLocalTestProcessRequestBody
         */
        SendMsgToOtherLocalTestProcessRequestBody.fromObject = function fromObject(object) {
            ...
            if (object.userNum != null) {
                ...
                message.userNum = $root.common.UInt32Value.fromObject(object.userNum);
            }
            if (object.appDomain != null) {
                if (typeof object.appDomain !== "object")
                    throw TypeError(".test_stand.SendMsgToOtherLocalTestProcessRequestBody.appDomain: object expected");
                message.appDomain = $root.common.StringValue.fromObject(object.appDomain);
            }
            if (object.appComponent != null) {
                if (typeof object.appComponent !== "object")
                    throw TypeError(".test_stand.SendMsgToOtherLocalTestProcessRequestBody.appComponent: object expected");
                message.appComponent = $root.common.StringValue.fromObject(object.appComponent);
            }
         ...
         */
        SendMsgToOtherLocalTestProcessRequestBody.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
            ...
            if (message.userNum != null && message.hasOwnProperty("userNum"))
                object.userNum = $root.common.UInt32Value.toObject(message.userNum, options);
            if (message.appDomain != null && message.hasOwnProperty("appDomain"))
                object.appDomain = $root.common.StringValue.toObject(message.appDomain, options);
            if (message.appComponent != null && message.hasOwnProperty("appComponent"))
                object.appComponent = $root.common.StringValue.toObject(message.appComponent, options);
            if (message.msgJson != null && message.hasOwnProperty("msgJson"))
    ...
    test_stand.ObserveOtherTestProcessRequestBody = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ObserveOtherTestProcessRequestBody.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.userNum != null && Object.hasOwnProperty.call(message, "userNum"))
                $root.common.UInt32Value.encode(message.userNum, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ObserveOtherTestProcessRequestBody.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        ObserveOtherTestProcessRequestBody.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.userNum != null && message.hasOwnProperty("userNum")) {
                var error = $root.common.UInt32Value.verify(message.userNum);
         ...
         * @returns {test_stand.ObserveOtherTestProcessRequestBody} ObserveOtherTestProcessRequestBody
         */
        ObserveOtherTestProcessRequestBody.fromObject = function fromObject(object) {
         ...
         * @returns {Object.<string,*>} Plain object
         */
        ObserveOtherTestProcessRequestBody.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
